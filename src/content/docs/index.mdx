...
Lua code can easily become hard to reason about, especially with its prototypes via the metatable approach and the inherent lack of [typed data.](https://en.wikipedia.org/wiki/Data_type) By writing tests first, you eliminate the guesswork and ensure your code is correct, readable, and resilient.
...
*   A local development machine (personal computer, laptop, etc.) with [Lua](https://www.lua.org/) (5.4 or 5.5+) installed.
